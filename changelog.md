...
**16**. По возможности использовать декораторы: `@Input()`, `@Output()`. По возможности использовать два или более метода-хука жизненого цикла компонента. Использовать DOM событие (click, wheel, blur...).
