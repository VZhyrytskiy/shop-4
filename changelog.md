...
**30.** Применены встроенные пайпы: для форматирования цены, для форматирования в верхний/нижний регистр, для форматирования текущей даты.
...
**33.** Зарегистрирован `OrderByPipe` в `SharedModule`. Применен в приложении для сортировки товаров корзины по `id`. 
