...
**15**. Создайте или модифицируйте `CartListComponent`, который отображает список купленных товаров. Кроме списка купленных товаров, отображать количество купленных товаров и общую сумму.

**16**. По возможности использовать декораторы: `@Input()`, `@Output()`. По возможности использовать `OnPush` стратегию для компонентов. По возможности использовать два или более метода-хука жизненого цикла компонента. Использовать DOM событие (click, wheel, blur...).
